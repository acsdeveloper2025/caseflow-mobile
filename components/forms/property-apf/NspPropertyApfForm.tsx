...
const NspPropertyApfForm: React.FC<NspPropertyApfFormProps> = ({ caseData }) => {
  ...
  return (
    <div className="space-y-4 pt-4 border-t border-dark-border">
      <h3 className="text-lg font-semibold text-brand-primary">NSP Property APF Report</h3>
      ...
      {/* Conditional Fields - Only show if flat is open */}
      ...
      {/* Continue TPC Section with TPC 2 */}
      <div className="p-4 bg-gray-900/50 rounded-lg space-y-4 border border-dark-border">
        <h4 className="font-semibold text-brand-primary">Third Party Confirmation (Continued)</h4>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">

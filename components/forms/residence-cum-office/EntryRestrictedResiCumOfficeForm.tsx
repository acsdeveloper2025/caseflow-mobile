    ...
    <div className="space-y-4 pt-4 border-t border-dark-border">
      ...
      <div className="p-4 bg-gray-900/50 rounded-lg space-y-4 border border-dark-border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <SelectField label="Applicant Staying Status" id="applicantStayingStatus" name="applicantStayingStatus" value={report.applicantStayingStatus || ''} onChange={handleChange} disabled={isReadOnly}><option value="">Select...</option>{options.applicantStayingStatus}</SelectField>
